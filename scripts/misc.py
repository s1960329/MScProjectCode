...
fileNamesRoot    = { "kpi"      : f"{dataPath}/dataROOT/kpiG_MC_Bd2KstGamma_HighPt_prefilter_2018_noPIDsel.root",
                     ...
                     "pipipf"   : f"{dataPath}/dataROOT/pipiG_prefilterBDT_2018_all_wPIDsel.root",
                     "kpipf"    : f"{dataPath}/dataROOT/kpiG_prefilterBDT_2018_all_wPIDsel.root"}
...
def getFoMandBestCut(cuts, model, inputData):
    ...
    inputData["prediction"] = model.predict(inputData)
