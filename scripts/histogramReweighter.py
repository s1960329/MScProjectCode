...
class GBReweight():
    ...
    def __init__(self, monteCarloRootFile, sampleRootFile, decayMode = "kpi"):
        ...
        self.trainingVariables   = sharedFeatures[:5] + [allFeatures[decayMode][10]]
        self.readData()
    ...
    def readData(self):
        ...
        self.sampleData          = readRootFile(self.sampleRootFile, allFeatures["kpi"] + ["NB0_Kpigamma_sw"])
    ...
    def trainReweighter(self):
        sampleTrainingVariables = sharedFeatures[:5] + [allFeatures["kpi"][10]]
