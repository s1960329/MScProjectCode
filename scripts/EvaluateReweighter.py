...
from misc import formatForClassification, normaliseData
...
((X_train,Y_train,W_train),(X_test,Y_test,W_test)) = formatForClassification(trainingVariables, signalPath=fileNamesCSV["pipi"], backgroundPath=fileNamesCSV["sm"], evenSplit=True)
